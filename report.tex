...
\begin{figure}[h]
    ...
    \caption{Deployment architecture showing three servers (10.96.0.255, 10.96.0.87, 10.96.0.62) each running a worker process with gRPC communication over TCP/IP.}
...
\begin{tikzpicture}[node distance=4cm]
    ...
    \node[circle,draw,minimum size=2cm,below of=W1] (W2) {Worker 2\\10.96.0.62};
...
2025-11-24 21:15:33 - INFO - Worker 0 connected to peer 2 at 10.96.0.62:50051
